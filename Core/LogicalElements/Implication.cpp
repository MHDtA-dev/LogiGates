...
namespace LogiGates::Core::LogicalElements {
    ...
    Implication::Implication(UI::Workspace *workspace) : Base(workspace) {
        this->typeName = "implication";
    ...
    void Implication::render() {
        ImNodes::BeginNode(id);
        ImGui::Image((ImTextureID) UI::Images::icons["implication"]->texture, {70, 70});
